	...
	?>
		<div class="rev-wu-image">
			<a class="wppr-default-img" href="<?php echo esc_url($image_link); ?>" <?php echo $lightbox; ?> rel="nofollow" target="_blank">
				<img src="<?php echo esc_attr($review_object->get_small_thumbnail()); ?>" alt="<?php echo esc_attr($review_object->get_name()); ?>" class="photo photo-wrapup wppr-product-image" />
			</a>
...
if (!function_exists('wppr_layout_get_image')) {
	...
	function wppr_layout_get_image($review_object, $class_a = '', $class_img = '')
	{
		...
		<a title="<?php echo $review_object->get_name(); ?>" class="<?php echo $class_a; ?>" href="<?php echo esc_url($image_link); ?>" <?php echo $lightbox; ?> rel="nofollow" target="_blank">
			<img width="100" height="100" style="width: 100px; height: 100px;" src="<?php echo esc_attr($src); ?>" alt="<?php echo esc_attr($review_object->get_image_alt()); ?>" class="<?php echo $class_img; ?>" />
		</a>
	<?php
	}
}
	...
	function wppr_layout_get_privacy_info($review_object)
	{
		...
		<div class="review-wu-privacy-bar">
			<div class="review-wu-privacy-app">
				...
				<a rel="nofollow" href="javascript:;" data-handle="<?= esc_attr($report['handle']) ?>" data-modal-id="review-wu-privacy-reports" data-modal-title="<?= __('Versions', 'wp-product-review') ?>" data-modal-loading-img="<?php echo WPPR_URL; ?>/assets/img/loading.svg" class="review-wu-privacy-app__version"><?= $report['version_name'] ?></a>
			</div>
			<div class="review-wu-privacy-trackers">
				...
				<a rel="nofollow" href="javascript:;" data-handle="<?= esc_attr($report['handle']) ?>" data-version-code="<?= esc_attr($report['version_code']) ?>" data-modal-id="review-wu-privacy-trackers" data-modal-title="<?= __('Privacy Report', 'wp-product-review') ?>" data-modal-loading-img="<?php echo WPPR_URL; ?>/assets/img/loading.svg" class="review-wu-privacy-trackers__more"><?= __('Trackers', 'wp-product-review') ?></a>
			</div>
			<div class="review-wu-privacy-permissions">
				...
				<a rel="nofollow" href="javascript:;" data-handle="<?= esc_attr($report['handle']) ?>" data-version-code="<?= esc_attr($report['version_code']) ?>" data-modal-id="review-wu-privacy-permissions" data-modal-title="<?= __('Privacy Report', 'wp-product-review') ?>" data-modal-loading-img="<?php echo WPPR_URL; ?>/assets/img/loading.svg" class="review-wu-privacy-permissions__more"><?= __('Permissions', 'wp-product-review') ?></a>
			</div>
		</div>
<?
	}
